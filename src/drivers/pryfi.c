...
{
	PRYFI_LOG("ToSpr allow_change_wpa_state: intf->hwaddr_modified => %d", intf->hwaddr_modified);
	PRYFI_LOG("Tospr allow_change_wpa_state: wpa_s->wpa_state => %d", wpa_s->wpa_state);
